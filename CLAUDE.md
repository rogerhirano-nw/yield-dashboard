...
- `docs/assertive_yield/ssp_params_migration.md` — full S2S / Prebid Server
  ...
  refreshed exports in and re-run rather than hand-editing the `.md`. The same
  data is also published as a spreadsheet,
  `docs/assertive_yield/Newsweek_SSP_Params_Assertive_Yield_Migration.xlsx`
  (Read me · Bidder roster · Account-level IDs · Parameters (tidy) · Desktop ·
  Mobile), regenerated by `docs/assertive_yield/build_spreadsheet.py`.
